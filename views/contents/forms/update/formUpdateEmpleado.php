 ...
 * @param Empleado $datos - Datos a mostrar en los campos obtenidos de la BD
 * @return string
 */
function formUpdateEmpleado($usuario, $datos) {
    $form = '';

    if (isset($datos)) {
        $form .= '<form action="?c=empleados&a=update" method="post" id="formUpdate">'
                . '<fieldset>'
